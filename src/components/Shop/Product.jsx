    ...
    <div className="garments">
      <Card style={{ border: "none" }}>
        <Card.Img
          ...
          key={product.img1}
          value={product.img1}
          src={require("../../static/img/stock-photos/" +
            product.img1 +
            ".jpeg")}
          onMouseOver={(image) =>
            (image.currentTarget.src = require("../../static/img/stock-photos/" +
              product.img2 +
              ".jpeg"))
          }
          onMouseOut={(image) =>
        ...
        <Card.Body className="garment-body">
          <Card.Title key={product.name} value={product.name}>
            {product.name}
          </Card.Title>
          <Card.Text key={product.price} value={product.price}>
            ${product.price}
          </Card.Text>
          <select
            key={product._id}
